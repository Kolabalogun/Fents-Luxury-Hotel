  ...
  return (
    <div className="bg-[#f5f6f7] w-full ml-[17%] min-h-[100vh] px-4 py-1 pb-4 h-full dashboard">
      ...
      <>
        ...
        "
          >
            <h6 className="text-[#0d1727] text-3xl leading-relaxed font-semibold mb-1">
              FAQ Messages
            </h6>
              ...
              <div key={msg.dateId} className="border mb-4">
                <div className=" p-[50px] sm-p-[20px]">
                  <div className="text-gray-700 text-[12px] mb-[5px] font-rubik uppercase ">
                    <span>Sent on {msg.timestamp.toDate().toDateString()}</span>
                    &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                    <span>
                      <span className="text-medium-gray ">{msg.username}</span>
                    </span>
                  </div>

                  <a
                    href="blog-standard-post.html"
                    class="text-black uppercase text-xl font-cumm  font-bold mb-[15px] hover:text-rubik"
                  >
                    {msg.subject}
                  </a>
